...
<body class="flex min-h-screen">
    ...
    <script>
        lucide.createIcons();
        (function () {
            var data = <?= json_encode($chartPayload, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) ?>;
            ...
            if (document.getElementById('chartPipeline')) {
            ...
            if (document.getElementById('chartMonths')) {
