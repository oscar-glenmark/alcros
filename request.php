        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
            ...
            <form method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="citizen_name" required value="<?= htmlspecialchars($draft['citizen_name'] ?? '') ?>"
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth" required value="<?= htmlspecialchars($draft['date_of_birth'] ?? '') ?>"
                           class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">
                </div>
                <div>
                    <label class="flex items-center gap-2 text-[11px] font-bold text-gray-700 mb-1.5">
                ...
                <div class="flex justify-between items-center pt-4">
                    ...
                    <button type="submit" name="action" value="next" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full text-sm font-bold flex items-center gap-2" data-loading-text="Saving…">Continue <i data-lucide="chevron-right" class="w-4 h-4"></i></button>
                </div>
            </form>
            ...
            <form method="POST" class="space-y-5">
                ...
                <p class="text-[11px] text-gray-400">Office hours: 8:00 AM – 5:00 PM (Monday to Friday). Subject to staff confirmation.</p>
                <div class="flex justify-between items-center pt-4">
                    <button type="submit" name="action" value="back" class="text-gray-400 text-sm flex items-center gap-1 hover:text-gray-600"><i data-lucide="chevron-left" class="w-4 h-4"></i> Back</button>
                    <button type="submit" name="action" value="next" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full text-sm font-bold flex items-center gap-2" data-loading-text="Submitting…">Submit Request <i data-lucide="chevron-right" class="w-4 h-4"></i></button>
                </div>
            </form>
            <?php endif; ?>
        </div>
